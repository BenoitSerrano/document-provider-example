            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        decisionField = lodash_1.omit(lib_1.generateDecision(), ['_id', 'labelStatus', 'labelTreatments']);
                    ...
                    case 3:
                        decision = _a.sent();
                        expect(lodash_1.omit(decision, ['_id', 'labelStatus', 'labelTreatments'])).toEqual(decisionField);
                        return [2 /*return*/];
                }
            });
        }); });
